...
RIDDLES_DATA = [
    {
        'question': 'Каких камней нет в море?',
        'answer': 'Сухих'
    },
    {
    ...
    {
        'question': 'У вас есть только одна спичка. В тёмной комнате стоят '
                    'керосиновая лампа, печь и свеча. Что вы зажжёте в первую очередь?',
        'answer': 'Спичку'
    },
    {
